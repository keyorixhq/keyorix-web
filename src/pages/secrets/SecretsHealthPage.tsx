    ...
    if (error) {
        return (
            <div className="max-w-7xl mx-auto px-6 py-8">
                <Alert type="error" title="Failed to load health data" message="Could not fetch secrets or dashboard stats. Please try again.">
                    <button
            ...
            <div className="max-w-7xl mx-auto px-6 py-8 space-y-8">
                ...
                <div>
                    ...
                    <p className="mt-1 text-sm text-base-muted">
                        Hygiene posture across {fmt(total)} secret{total !== 1 ? 's' : ''} — expiry, rotation, and access coverage
                    </p>
                </div>
                    ...
                    <>
                        ...
                        <div className="bg-surface border border-base rounded-xl shadow-xs">
                            <div className="px-6 py-4 border-b border-base">
                                ...
                                <p className="text-xs text-base-muted mt-0.5">Based on expiry, rotation, and access hygiene</p>
                            </div>
                            <div className="p-6 flex flex-col sm:flex-row gap-8 items-center sm:items-start">
                                ...
                                <div className="flex flex-col items-center gap-2 shrink-0">
                                    ...
                                    <span
                                        ...
                                        style={{ color: scoreLabelColor(score) }}
                                    >
                                        {scoreLabel(score)}
                                    </span>
                                </div>
                                ...
                                <div className="flex-1 min-w-0 space-y-5 w-full">
                                    ...
                                    <ComponentRow label="Rotation Health" pct={rotation.pct} weight="30%" unavailable={!rotation.available} />
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            >
                                ...
                                <StatRow
                                    ...
                                    dot={access.failedAuth24h === 0 ? 'green' : access.failedAuth24h >= 5 ? 'red' : 'amber'}
                                />
                                <StatRow
