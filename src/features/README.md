...
| `dashboard/` | api hooks (useDashboardStats, useDashboardActivity, useSystemInfo, useSystemMetrics, useAnomalyAlerts, useAcknowledgeAnomaly, useUsers, useUser, useGroups, useGroup) |                                                                  |
