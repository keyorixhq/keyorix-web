...
export const PasswordResetForm: React.FC<PasswordResetFormProps> = ({
    ...
    const validateForm = (): boolean => {
        ...
        if (!isValidEmail(email)) { setValidationError('Please enter a valid email address'); return false; }
        setValidationError('');
        return true;
    };
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try { await onSubmit({ email }); } catch { /* handled by parent */ }
    };
        ...
        <form onSubmit={handleSubmit} className="space-y-6" noValidate>
            ...
            <div>
                ...
                <input
                    ...
                    disabled={isLoading}
                />
                {validationError && <p className="mt-1 text-sm text-red-600" role="alert">{validationError}</p>}
            </div>
