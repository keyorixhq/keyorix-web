...
const SSOCompletePage    = React.lazy(() => import('./pages/auth/SSOCompletePage').then(m => ({ default: m.SSOCompletePage })));

const DashboardPage      = React.lazy(() => import('./pages/dashboard/DashboardPage').then(m => ({ default: m.DashboardPage })));

const SecretsListPage    = React.lazy(() => import('./pages/secrets/SecretsListPage').then(m => ({ default: m.SecretsListPage })));
const DynamicSecretsPage = React.lazy(() => import('./pages/secrets/DynamicSecretsPage'));
const RotationPoliciesPage = React.lazy(() => import('./pages/secrets/RotationPoliciesPage').then(m => ({ default: m.RotationPoliciesPage })));
const SecretExpiryPage   = React.lazy(() => import('./pages/secrets/SecretExpiryPage').then(m => ({ default: m.SecretExpiryPage })));
const SecretsHealthPage  = React.lazy(() => import('./pages/secrets/SecretsHealthPage').then(m => ({ default: m.SecretsHealthPage })));
const UsageAnalyticsPage = React.lazy(() => import('./pages/secrets/UsageAnalyticsPage').then(m => ({ default: m.UsageAnalyticsPage })));

const ProjectsListPage   = React.lazy(() => import('./pages/projects/ProjectsListPage').then(m => ({ default: m.ProjectsListPage })));
...
const SharingManagementPage = React.lazy(() => import('./pages/sharing').then(m => ({ default: m.SharingManagementPage })));
...
const UserDetailPage     = React.lazy(() => import('./pages/admin/UserDetailPage').then(m => ({ default: m.UserDetailPage })));
const RolesPoliciesPage  = React.lazy(() => import('./pages/admin/RolesPoliciesPage').then(m => ({ default: m.RolesPoliciesPage })));
const GroupsPage         = React.lazy(() => import('./pages/admin/GroupsPage').then(m => ({ default: m.GroupsPage })));
const ServiceAccountsPage = React.lazy(() => import('./pages/admin/ServiceAccountsPage').then(m => ({ default: m.ServiceAccountsPage })));
const APITokensPage      = React.lazy(() => import('./pages/admin/APITokensPage').then(m => ({ default: m.APITokensPage })));

const AppearancePage     = React.lazy(() => import('./pages/settings/AppearancePage').then(m => ({ default: m.AppearancePage })));
const CompliancePage     = React.lazy(() => import('./pages/compliance/CompliancePage').then(m => ({ default: m.CompliancePage })));
const KeyorixConnectPage = React.lazy(() => import('./pages/integrations/KeyorixConnectPage').then(m => ({ default: m.KeyorixConnectPage })));
